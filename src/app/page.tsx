...
export default function Home() {
  return (
    <h1>asdsad</h1>
    // <section className="border w-[1104px] max-w-full mx-auto px-6 py-8 grid lg:grid-cols-5 gap-12 sm:gap-16 items-center">
    //   <div className="lg:col-span-3">
    //     <p className="text-sm font-mono text-neutral-600 dark:text-neutral-300">
    //       PORTFOLIO / 2025
    //     </p>
    //     <h1 className="text-neutral-800 dark:text-neutral-100 tracking-tight text-2xl md:text-4xl text-pretty mt-2 mb-4">
    //       Farhan Nur Hidayat
    //     </h1>

    //     <p className="text-neutral-600 dark:text-neutral-300 font-sans text-base">
    ...
    //           <span
    //             key={skill}
    //             className="font-sans px-3 py-1 text-xs border border-border rounded-full hover:border-muted-foreground/50 transition-colors duration-300"
    //           >
    //             {skill}
    //           </span>
    //         ))}
